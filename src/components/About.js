        ...
        <section id="about">
            <div className="container">
                ...
                <div className="contact-item d-flex align-items-center">
                    <img src={process.env.PUBLIC_URL + '/mail.svg'} className="icon" alt="mail icon" />
                    <p className="icon-label ml-3 mb-0 align-baseline">musababdullah6231@gmail.com</p>
                </div>

                <div className="contact-item d-flex align-items-center">
                    <img src={process.env.PUBLIC_URL + '/phone.svg'} className="icon" alt="phone icon" />
                    <p className="icon-label ml-3 mb-0 align-baseline">(512)-791-6737</p>
                </div>

                <div className="contact-item d-flex align-items-center">
                    <img src={process.env.PUBLIC_URL + '/github.svg'} className="icon" alt="github icon" />
                    <p className="icon-label ml-3 mb-0 align-baseline">github.com/musabdullah0</p>
                </div>

                <div className="contact-item d-flex align-items-center">
                    <img src={process.env.PUBLIC_URL + '/linkedin.svg'} className="icon" alt="linkedin icon" />
